...
export default function PitchDeckSection({ onCTAClick }: Props) {
  ...
  return (
    <section id="pitch-deck" className="bg-white">

      {/* Section label */}
      <div className="max-w-[1400px] mx-auto px-6 pt-[clamp(4rem,8vw,7rem)] pb-10">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-8 h-[2px] bg-[#0077c2] rounded" />
          <span className="text-[0.67rem] font-bold tracking-[0.32em] uppercase text-[#0077c2]">
            Pitch Deck Services
          </span>
        </div>
        <p className="text-gray-400 text-[0.95rem] max-w-xs">
              ...
              <div className="flex flex-col justify-between flex-1 p-8 md:p-12 gap-6">
                ...
                <div className="flex items-start justify-between gap-6 flex-wrap">
                  ...
                  <div>
                    ...
                    <p className="text-[0.75rem] font-semibold text-gray-400 tracking-wide">{card.sub}</p>
                  </div>
                ...
                <div>
                  ...
                  >
                    <span className="block text-gray-900">{card.title.split(" ")[0]}</span>
                ...
                <div className="space-y-5">
                  <p className="text-gray-500 text-[0.95rem] leading-relaxed max-w-[55ch]">
                    {card.desc}
                  </p>
                  <div
                  ...
                  >
                    {card.tags.map(t => (
                      <span
                        key={t}
                        className="text-[0.75rem] font-medium text-gray-600 px-3.5 py-1.5 rounded-full bg-gray-100 border border-gray-200"
                      >
                        {t}
                      </span>
                    ))}
